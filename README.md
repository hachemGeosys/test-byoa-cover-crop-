...
This directory exposes an example of code that will enable you to this is the cover crop processor
...
1. Clone the project repository:
    ...
    ```
    git clone http://github.com/GEOSYS/cover-crop
    ```
...
4. Set up the Jupyter Notebook kernel for the project:
    ...
    ```
5. Open jupyter and then the example notebook (cover_crop.ipynb) by clicking on it.
...
3. Access the API by opening a web browser and navigating to the following URL:
   ...
   Body Example for cover_crop endpoint:
...
[stars-shield]: https://img.shields.io/github/stars/cover-crop/repo.svg?style=plastic&logo=appveyor
[stars-url]: https://github.com/github_username/repo/stargazers
[issues-shield]: https://img.shields.io/github/issues/GEOSYS/cover-crop/repo.svg?style=social
[issues-url]: https://github.com/GEOSYS/cover-crop/issues
...
[CITest-shield]: https://img.shields.io/github/workflow/status/GEOSYS/cover-crop/Continous%20Integration
[CITest-url]: https://img.shields.io/github/workflow/status/GEOSYS/cover-crop/Continous%20Integration
